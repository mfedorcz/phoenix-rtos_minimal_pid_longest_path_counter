...
int syscalls_pidPathCounter(void * ustack)
{
	pid_t * pid_anws;
	int minPID;
	GETFROMSTACK(ustack, pid_t *, pid_anws, 0);
	GETFROMSTACK(ustack, int, minPID, 1);
	* pid_anws = 0;
	return posix_pidPathCounter(pid_anws, minPID);
}
